    ...
    AdminModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["I" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__node_modules_angular_forms__["a" /* FormsModule */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__admin_admin_module__ = __webpack_require__("./src/app/admin/admin.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_exam_service__ = __webpack_require__("./src/app/services/exam.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_ng2_pdf_viewer__ = __webpack_require__("./node_modules/ng2-pdf-viewer/ng2-pdf-viewer.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_9__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__web_web_module__["a" /* WebModule */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__services_exam_service__["a" /* ExamService */],
                __WEBPACK_IMPORTED_MODULE_2__services_testroom_service__["a" /* TestroomService */],
                __WEBPACK_IMPORTED_MODULE_0__services_pager_service__["a" /* PagerService */],
...
var AddExamService = /** @class */ (function () {
    function AddExamService(http, authenticationService) {
        this.http = http;
        this.authenticationService = authenticationService;
        this.Url = 'http://localhost:8080/toeichelper/api/';
...
var UploadfileService = /** @class */ (function () {
    function UploadfileService(http, authenticationService) {
        this.http = http;
        this.authenticationService = authenticationService;
        this.Url = 'http://localhost:8080/toeichelper/api/upload';
    }
...
var NvarbarComponent = /** @class */ (function () {
    function NvarbarComponent(authenticationService) {
        this.authenticationService = authenticationService;
        this.currentUser = JSON.parse(localStorage.getItem('currentUser'));
    }
